...
class driver;
  ...
  virtual interface_APB apb_vif; // Modificat din interface_output
  
  //creating mailbox handle
  mailbox gen2driv;
  
  //constructor
  function new(virtual interface_APB apb_vif, mailbox gen2driv); // Modificat din mem_intf
  ...
  task drive;
    ...
    //se asteapta ca modulul sa iasa din reset
     wait(out_vif.reset);//linie valabila daca resetul este activ in 0
    //wait(!out_vif.reset);//linie valabila daca resetul este activ in 1
