...
add wave -noupdate -label PRDATA /venindg_machine_tb/DUT_test_bench/prdata_o
add wave -noupdate /venindg_machine_tb/DUT_test_bench/alarm_o
add wave -noupdate /venindg_machine_tb/DUT_test_bench/success_o
add wave -noupdate -radix unsigned /venindg_machine_tb/DUT_test_bench/change_o
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {38275 ps} 0}
...
update
WaveRestoreZoom {0 ps} {319330 ps}
